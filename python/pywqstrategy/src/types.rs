...
//     pub(crate) inner: rwqstrategy::select::StrategyResult,
// }

// impl From<rwqstrategy::select::StrategyResult> for StrategyResult {
//     fn from(inner: rwqstrategy::select::StrategyResult) -> Self {
//         Self { inner }
//     }
// }
