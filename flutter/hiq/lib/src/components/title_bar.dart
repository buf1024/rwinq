...
import 'package:hiq/src/app/constant.dart';
...
class _TitleBarState extends State<TitleBar> {
  Map<HiqThemeMode, IconData> themeIconMap = {
    HiqThemeMode.dark: IconFont.darkMode,
    HiqThemeMode.light: IconFont.lightMode,
    HiqThemeMode.system: IconFont.systemMode,
  };
...
class _ThemeSwitchWidget extends StatefulWidget {
  final Map<HiqThemeMode, IconData> themeIconMap;
  final Map<HiqThemeMode, String> themeLabelMap;
  final HiqThemeMode themeMode;
  final ValueChanged<HiqThemeMode> onThemeSwitch;
...
class _ThemeSwitchWidgetState extends State<_ThemeSwitchWidget> {
  final Set<HiqThemeMode> themeMouseInSet = {};
  late HiqThemeMode themeMode;
  @override
  void initState() {
    super.initState();
  ...
  BoxDecoration? _themeBoxDecoration(HiqThemeMode mode) {
